export const timeline = [
  ...
  { period: "2011–2021", title: "E-commerce decade", text: "Built digital presence, POS and inventory systems and worked across e-commerce and digital projects including Saleem Fabrics, Tradition Stores, Ghani Cloth House, Roop Singhar, Heer Pret and The Dressmaker Studio." },
  { period: "2021–now", title: "Digital growth", text: "Expanded into multichannel marketing, CRM, analytics, e-commerce strategy, digital transformation and growth." },
  { period: "Now", title: "Technology · AI · products", text: "Building software, experimenting with AI and exploring products that sit at the intersection of commerce, growth and technology." },
];

export const capabilities = [
  { title: "Strategy", items: ["Growth strategy", "Digital strategy", "Business thinking", "Customer journey"] },
  { title: "Marketing", items: ["Multichannel campaigns", "Social", "Email", "Advertising", "SMS", "Copywriting"] },
  { title: "Customer & CRM", items: ["e-CRM", "Segmentation", "Lifecycle marketing", "B2C / B2B", "Analytics", "Optimisation"] },
  { title: "Commerce", items: ["E-commerce", "Shopify", "Digital merchandising", "CRO", "POS", "Inventory"] },
  { title: "Communication", items: ["Teaching", "Presentation", "Editing", "Stakeholder management", "Cross-functional communication"] },
  { title: "Technology", items: ["React", "Next.js", "TypeScript", "Node.js", "Firebase", "Flutter", "APIs", "Automation"] },
  { title: "AI & Product", items: ["AI products", "LLM applications", "Generative AI", "SaaS", "Product development", "AI × Commerce"] },
];
...
export const principles = [
  ["People before platforms.", "Technology changes. Human behaviour remains central."],
  ["Systems create leverage.", "Good processes compound."],
  ["Data makes intuition accountable.", "Measure what happens."],
  ["Commerce is more than a storefront.", "Products, customers, operations and technology have to work together."],
  ["Build, don't just recommend.", "Strategy becomes more valuable when you can execute it."],
  ["Stay curious.", "The next opportunity often hides between disciplines."],
] as const;
